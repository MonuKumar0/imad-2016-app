...
app.get('/rsz_hm.jpg', function (req, res) {
  res.sendFile(path.join(__dirname, 'rsz_hm.jpg'));
});
app.get('/rsz_bd1.jpg', function (req, res) {
  res.sendFile(path.join(__dirname, 'rsz_bd1.jpg'));
});
