...
bar.style.top="278px";
     di.innerHTML="<div style=position:absolute;width:225px;height:150px;top:20px;left:20px;><iframe width=225px height=150px src='https://www.youtube.com/embed/YC__12iAJGc'></iframe></div><div style=position:absolute;width:225px;height:150px;top:20px;left:260px;background-color:red;><iframe width=225px height=150px src='https://www.youtube.com/embed/YC__12iAJGc'></iframe></div><div style=position:absolute;width:225px;height:150px;top:20px;left:500px;background-color:red;><iframe width=225px height=150px src='https://www.youtube.com/embed/YC__12iAJGc'></iframe></div>";
    di.style.border="thick solid aqua";
