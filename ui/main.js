...
bar.style.top="278px";
     di.innerHTML="<div style=position:absolute;left:20px;top:20px;width:225px;height:150px;background-color:red;><iframe width=225px height=150px src='https://www.youtube.com/embed/zmEG-5zEmPw' /iframe></div>"+"<div style=width:225px;height:150px;position:absolute;top:20px;left:265px;><iframe width=225px height=150px src='https://www.youtube.com/embed/zmEG-5zEmPw'/iframe></div>";
    di.style.border="thick solid aqua";
