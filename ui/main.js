...
pr.onclick=function(){
    di.innerHTML="<div style="+"position:absolute;top:20px;right:10px;background-image:url(/49be6b5a-9690-4e04-b6fb-7e194463d0d7.jpg);height:100px;width:100px;></div>";
    di.style.border="thick solid blue";
    bar.style.top="190px";
