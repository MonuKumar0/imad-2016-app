...
bar.style.top="278px";
     di.innerHTML="<div style=position:absolute;left:20px;top:20px;width:225px;height:150px;><iframe width=225px height=150px src='https://www.youtube.com/embed/zmEG-5zEmPw'/iframe></div>"+"<div style=position:width:225px;height:150px;absolute;top:300px;left:20px;background-color:red;></div>";
    di.style.border="thick solid aqua";
